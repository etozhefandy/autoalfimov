...
ACCESS_TOKEN = "EAASZCrBwhoH0BO7xBXr2h2sGTзvWzUyViJjnrXIvmI5w3uRQOszdntxDiFYxXH4hrKTmZBaPKtuthKuNx3rexRev5zAkby2XbrM5UmwzRGz8a2Q4WBDKp3d1ZCZAAhZCeWFBObQayL4XPwrOFQUtuPcGP5XVYubaXjZCsNT467yKBg90O71oVPZCbI0FrWcZAZC4GtgZDZD"
APP_ID = "1336645834088573"
APP_SECRET = "01bf23c5f726c59da318daa82dd0e9dc"
FacebookAdsApi.init(APP_ID, APP_SECRET, ACCESS_TOKEN)

# ПОРЯДОК, как ты просил
AD_ACCOUNTS = [
    ...
    "act_2183299115451405",  # ЖС Шымкент 2 (рядом с Шымкентом)
...
# Переписки — как было (Караганда уже добавлена)
MESSAGING_ACCOUNTS = {
    ...
    "act_195526110289107", "act_2145160982589338", "act_719853653795521"
}

# Заявки с сайта — убрал оба Kense, оставил Инвестиции
LEAD_FORM_ACCOUNTS = {
    "act_798205335840576"
}
...
def _is_permission_error(err: Exception) -> bool:
    s = str(err)
    return ("Ad account owner has NOT grant" in s) or ('"code": 200' in s) or "OAuthException" in s
...
def is_account_active(account_id):
    try:
        ...
        return "🔴"  # без прав считаем «не активен»
...
def get_facebook_data(account_id, date_preset, date_label=''):
    ...
    try:
        ...
        if _is_permission_error(e):
            return None  # тихо пропускаем недоступные кабинеты
