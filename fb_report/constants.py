...
BOT_CHANGELOG = [
    ...
    "Today всегда по живым данным без текстового кэша и кэша инсайтов",
    "CPA-алёрты только владельцу в личку (по ALLOWED_USER_IDS)",
    "Настройки аккаунтов доступны только владельцу",
    "Кастомный выбор периода для отчётов и тепловой карты",
    "Подготовка часового кэша (день×час) для автопилота по тёплым часам",
]
