...
BOT_CHANGELOG = [
    "Последние обновления (v1.3.1):",
    "— Ads Manage: Бюджет-план (preview/apply) с подробными ошибками и итогом updated/skipped/failed",
    "— UI: защита от ошибок Telegram editMessageText + экранирование HTML (чтобы не ломалось на <...>)",
    "",
    "Ранее (v1.3.0):",
